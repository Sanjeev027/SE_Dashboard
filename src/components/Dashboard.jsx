            ...
            <main className="flex-1 flex flex-col overflow-hidden bg-[#0f1115]">
                ...
                <header className="h-20 border-b border-gray-800 flex items-center justify-between px-4 sm:px-8 bg-[#161b22]/50 backdrop-blur-md shrink-0">
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        <button onClick={() => setIsEventModalOpen(true)} className="flex items-center gap-2 bg-red-600 hover:bg-red-700 transition-all px-3 sm:px-5 py-2.5 rounded-xl font-medium shadow-lg shadow-red-600/20 text-xs sm:text-sm">
                            <Plus size={18} />
